 ...
 */
//Java program to filter out the user defined objects using stream
public class StreamExample4 {
	...
	public static void main(String[] args) {
		...
		System.out.println("Sorted as per the names of books----");
		list.stream().sorted((book1,book2) -> book1.name.compareTo(book2.name)).forEach(b->System.out.println(b.id+" "
				+b.name+" "+b.author+" "+b.publisher+" "+b.quantity));
		System.out.println("******Author names in UpperCase");
		list.stream().forEach(s->System.out.println(s.author.toUpperCase()));
	}
